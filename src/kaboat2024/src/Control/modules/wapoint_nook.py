...
class WaypointNavigator:
    def __init__(self):
        ...
        self.psi_error_past = 0.0
        self.psi_error_sum = 0.0
        self.u_error_past = 0.0
        self.u_error_sum = 0.0
        # Subscribers
        ...
        self.desire_pub = rospy.Publisher('/desire_waypoint',Float32, queue_size=10)
    ...
    def callback(self, utm_msg, imu_msg):
        ...
        desire_waypoint = self.calculate_desire(utm_coords, current_waypoint)
        # Publish angle
        # self.angle_pub.publish(angle_to_waypoint)
        self.desire_pub.publish(desire_waypoint)
    ...
    def calculate_desire(self, current_pos, waypoint):
        ...
        return Float32(data=angle_to_waypoint)
    ...
    def calculate_angle(self, current_pos, waypoint, current_yaw):
        ...
        #relative_angle = angle_to_waypoint
